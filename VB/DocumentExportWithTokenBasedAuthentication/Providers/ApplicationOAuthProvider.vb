...
Namespace T680906.Providers
	Public Class ApplicationOAuthProvider
		...
		Public Overrides Function TokenEndpoint(ByVal context As OAuthTokenEndpointContext) As Task
		...
		Public Overrides Function ValidateClientRedirectUri(ByVal context As OAuthValidateClientRedirectUriContext) As Task
		...
		Public Shared Function CreateProperties(ByVal userName As String) As AuthenticationProperties
